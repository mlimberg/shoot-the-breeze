...
export default class Application extends Component {
  ...
  storeMessage(message) {
    firebase.database().ref('messages').push(Object.assign(message, { time: Date.now(), user: this.state.user.displayName }));
    this.state.messages.push(Object.assign(message, { time: Date.now(), user: this.state.user.displayName}))
