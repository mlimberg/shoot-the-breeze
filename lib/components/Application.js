      ...
      return (
        <div className="application">
          ...
          <div className='signInBanner'>
            <Login className='signInButton' text="Sign In" authorize={signIn} setUser={ (userFromFirebase) => {
    ...
    return (
      <div className="application">
        ...
        <div className='currentUser'>
          ...
          <Login className='signOutButton' text="Sign Out" authorize={signOut} setUser={() => {
